...
TEST_F(VkLayerTest, VerityUnnormalizedCoordinatesSamperWithImageViewType) {
    ...
    const char fsSource[] =
        ...
        "layout(set = 0, binding = 1) uniform sampler s1[2];\n"
        ...
        "void main() {\n"
        "   vec4 x = texture(sampler2D(si2, s0), vec2(0));\n"
        "   x = texture(sampler3D(si3[1], s1[1]), vec3(0));\n"
    ...
    g_pipe.dsl_bindings_ = {{0, VK_DESCRIPTOR_TYPE_SAMPLER, 1, VK_SHADER_STAGE_FRAGMENT_BIT, nullptr},
                            ...
                            {3, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE, 2, VK_SHADER_STAGE_FRAGMENT_BIT, nullptr},
    ...
    g_pipe.descriptor_set_->WriteDescriptorImageInfo(0, nullptr, sampler, VK_DESCRIPTOR_TYPE_SAMPLER);
    g_pipe.descriptor_set_->WriteDescriptorImageInfo(1, nullptr, sampler, VK_DESCRIPTOR_TYPE_SAMPLER,
                                                     VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, 2);
    g_pipe.descriptor_set_->WriteDescriptorImageInfo(2, view_pass, nullptr, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE);
    g_pipe.descriptor_set_->WriteDescriptorImageInfo(3, view_fail, nullptr, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,
                                                     VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, 2);
